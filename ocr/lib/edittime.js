...
AddStringParam("Language", "Language.", '"vi"');
...
var property_list = [
	new cr.Property(ept_text, "Language", "vi", "Languages, listed in https://github.com/naptha/tesseract.js/blob/master/docs/tesseract_lang_list.md"),
